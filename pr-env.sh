...
load_secret_stream() {
    ...
    if [[ "$ACTION" == "deploy" ]]; then
        ...
        read_secret_line MERCHANT_ENRICHMENT_ENABLED
        read_secret_line MERCHANT_ENRICHMENT_TIMEOUT_MS
    ...
    export MERCHANT_ENRICHMENT_ENABLED
    export MERCHANT_ENRICHMENT_TIMEOUT_MS
...
MERCHANT_ENRICHMENT_ENABLED=${MERCHANT_ENRICHMENT_ENABLED:-0}
MERCHANT_ENRICHMENT_TIMEOUT_MS=${MERCHANT_ENRICHMENT_TIMEOUT_MS:-2000}
