...
load_secret_stream() {
    ...
    if [[ "$ACTION" == "deploy" ]]; then
        read_secret_line BRANDFETCH_API_KEY
        read_secret_line BRANDFETCH_CLIENT_ID
        read_secret_line VENDOR_ENRICHMENT_ENABLED
        read_secret_line VENDOR_ENRICHMENT_TIMEOUT_MS
        ...
        read_secret_line FEEDBACK_WEBHOOK_URL
    fi
    ...
    export VENDOR_ENRICHMENT_ENABLED
    export VENDOR_ENRICHMENT_TIMEOUT_MS
...
VENDOR_ENRICHMENT_ENABLED=${VENDOR_ENRICHMENT_ENABLED:-0}
VENDOR_ENRICHMENT_TIMEOUT_MS=${VENDOR_ENRICHMENT_TIMEOUT_MS:-2000}
